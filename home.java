...
public class home extends javax.swing.JFrame {
    ...
    private void jMenuItem10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem10ActionPerformed
        ...
        int a = JOptionPane.showConfirmDialog(null,"Do you really want to logout","Logout Window",JOptionPane.YES_NO_OPTION);
        if(a==0)
        {
        setVisible(false);
    ...
    private void jMenuItem11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem11ActionPerformed
        // TODO add your handling code here:
         int a = JOptionPane.showConfirmDialog(null,"Do you really want to Close application","Exit Window",JOptionPane.YES_NO_OPTION);
        if(a==0)
        {
        System.exit(0);
        }
